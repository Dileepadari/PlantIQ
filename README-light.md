...
form. This page shows **light mode**; the same gallery in
dark mode is at **[README.md](./README.md)**.

| | |
|---|---|
| **Dashboard** <br> Every sensor now, the VOC trend, threshold table and open alerts <br><br> <img src="docs/screenshots/light/dashboard.png" alt="PlantIQ dashboard" loading="lazy"> | **Statistics** <br> One chart per sensor across your chosen window <br><br> <img src="docs/screenshots/light/statistics.png" alt="Per-sensor charts" loading="lazy"> |
| **Analysis** <br> Each reading against the safe range for your plant <br><br> <img src="docs/screenshots/light/analysis.png" alt="Threshold analysis" loading="lazy"> | **History** <br> Every reading between two dates, exportable as CSV <br><br> <img src="docs/screenshots/light/history.png" alt="Reading history" loading="lazy"> |
| **Alerts** <br> Threshold breaches the firmware reported, by severity <br><br> <img src="docs/screenshots/light/alerts.png" alt="Alerts" loading="lazy"> | **Settings** <br> Which plant is being monitored, and how far the charts go back <br><br> <img src="docs/screenshots/light/settings.png" alt="Settings" loading="lazy"> |

<p align="center"><b>Circuit</b> &middot; what each sensor is, and the path from breadboard to dashboard</p>
<p align="center"><img src="docs/screenshots/light/circuit.png" alt="Circuit and system diagram" loading="lazy"></p>
...
|---|---|---|
| <img src="docs/screenshots/responsive/light/phone-dashboard.png" alt="Dashboard on a phone" loading="lazy"> | <img src="docs/screenshots/responsive/light/phone-alerts.png" alt="Alerts on a phone" loading="lazy"> | <img src="docs/screenshots/responsive/light/tablet-statistics.png" alt="Statistics on a tablet" loading="lazy"> |
